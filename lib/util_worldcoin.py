...
def get_wdc_supply(normalize=False, at_block_index=None):
    """returns the total supply of WDC (based on what worldcoind says the current block height is)"""
...
def pubkey_to_address(pubkey_hex):
    ...
    return encoding.public_pair_to_worldcoin_address(public_pair, compressed=compressed, address_prefix=address_prefix)
